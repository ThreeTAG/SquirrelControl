...
return [
    ...
    */
    ...
    'options' => [
        ...
        'repository' => 'git@gitlab.com:threetag/latest/squirrelcontrol.git',
        'php_fpm_service' => 'php7.0.33-fpm',
    ],
    ...
    */
    ...
    'hosts' => [
        'squirrelcontrol.threetag.net' => [
            'deploy_path' => '/var/www/squirrelcontrol',
            'user' => 'web',
        ],
    ],
